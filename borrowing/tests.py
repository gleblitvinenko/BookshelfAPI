...
class AuthenticatedBorrowingsApiTests(TestCase):
    ...
    def test_list_borrowings(self):
        ...
        sample_borrowing(borrower=self.user)
        sample_borrowing(borrower=self.user, book=book)
    ...
    def test_retrieve_borrowing_detail(self):
        borrowing = sample_borrowing(borrower=self.user)
...
class AdminBorrowingApiTests(TestCase):
    ...
    def test_list_borrowings_all_users(self):
        ...
        sample_borrowing(borrower=user1)
        sample_borrowing(borrower=user2)
        res = self.client.get(BORROWINGS_URL)
